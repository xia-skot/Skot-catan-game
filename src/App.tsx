      ...
      <div style={flexibleContainerStyle}>
        ...
        <div className="absolute bottom-0 left-0 w-full bg-white/70 backdrop-blur-xl border-t border-white/50 pt-3 pb-6 px-4 flex justify-center gap-12 shadow-[0_-10px_40px_rgba(0,0,0,0.03)] z-50">
           ...
           <button
             ...
             className={`flex flex-col items-center gap-1 transition-all text-slate-400 hover:text-slate-600 scale-100 hover:scale-110`}
           >
             <div className="p-2.5 rounded-2xl transition-all hover:bg-slate-100">
               <BookOpen size={22} />
             </div>
        ...
        <div className="flex items-center gap-2 lg:gap-3 shrink-0 cursor-default lg:absolute lg:left-2">
          <div className="flex items-center gap-2 lg:gap-3 relative" onClick={handleLogoClick}>
            ...
            <div className="flex items-center pr-4 border-r border-black/5 relative gap-2 h-full">
              ...
              <div className="relative z-10 flex flex-col items-start justify-center font-sans gap-[1px]">
                <span className="text-[8px] lg:text-[9px] uppercase font-black tracking-[0.2em] opacity-30 leading-none">海域代码</span>
                <span className="text-xs lg:text-sm uppercase font-black tracking-tighter opacity-90 leading-none">{roomState?.roomId || 'OFFLINE'}</span>
              </div>
              <div className="relative z-10 flex flex-col items-center justify-center gap-[3px] ml-0.5">
                <button 
                ...
                <div className="flex items-center justify-center text-stone-400 relative" title="观战人数">
                  <Eye size={12} strokeWidth={2.5} className="fill-transparent" />
                  <span className="absolute left-full ml-0.5 text-[9px] font-mono font-black">{roomState?.spectators?.length || 0}</span>
                </div>
              </div>
              {isSpectator && (
                <button 
