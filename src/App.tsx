              ...
              {isHostInLobby && (
                ...
                >
                  {roomState?.settings?.customBoard ? (
                    ...
                    <>
                      <span className="text-sm group-hover:scale-110 transition-transform relative z-10">🧭</span>
                      <span className="text-[8px] font-black uppercase tracking-widest text-indigo-900 mt-1 relative z-10 transition-opacity opacity-100">地图收藏</span>
                    </>
                  )}
                </button>
              )}
