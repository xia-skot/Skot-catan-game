...
export default function App() {
  ...
  const [activeLobbyTab, setActiveLobbyTab] = useState<'lobby' | 'profile'>('lobby');
  ...
  if (!isJoinedLobby) {
    return (
      ...
      <div style={flexibleContainerStyle}>
          ...
          {activeLobbyTab === 'lobby' ? (
            ...
            >
              <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-2 bg-slate-50 rounded-2xl flex items-center justify-center shadow-inner border border-slate-100 relative" onClick={handleLogoClick}>
                ...
                <img src={`/api/proxy-image?url=${encodeURIComponent('http://tdyuzzmmy.hn-bkt.clouddn.com/img/C3eURTs - Imgur.png')}`} alt="Catan Logo" className="w-8 h-8 sm:w-12 sm:h-12 object-contain drop-shadow-lg" />
              </div>
             ...
             <div className="w-full h-full max-w-[90vw] sm:max-w-md pt-0 rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden flex shadow-2xl bg-white border border-slate-100">
               <UserProfileModal
        ...
        {/* Bottom Tab Bar */}
        <div className="absolute bottom-0 left-0 w-full bg-white/70 backdrop-blur-xl border-t border-white/50 pt-3 pb-6 px-4 flex justify-center gap-12 shadow-[0_-10px_40px_rgba(0,0,0,0.03)] z-50">
           <button
