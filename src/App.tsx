        ...
        >
          <div className="flex flex-col gap-2 sm:gap-4 w-full max-w-sm mx-auto h-full">
            ...
            <div className="pt-2 sm:pt-4 flex flex-col items-center gap-2 border-t border-slate-100">
               ...
               >
                 <LogOut size={12} className={isSpectator ? "scale-x-[-1]" : ""} />
        ...
        <main className="flex-1 flex relative overflow-hidden bg-[#e4e3e0]">
          ...
          {gameStarted && (
            <div className={`absolute top-1 left-1 z-[1000] flex flex-col gap-0.5 pointer-events-auto ${isMobile ? 'scale-90 origin-top-left' : ''}`}>
              ...
              >
                <LogOut size={isMobile ? 14 : 18} className={`group-hover:-translate-x-0.5 transition-transform ${isSpectator ? 'scale-x-[-1]' : ''}`} />
