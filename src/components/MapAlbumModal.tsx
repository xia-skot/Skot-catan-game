              ...
              {filteredMaps.map(map => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <h3 className={`text-sm font-black uppercase tracking-widest ${isSelected ? 'text-indigo-900' : 'text-stone-800'}`}>{map.name}</h3>
                    ...
                    <div className="flex gap-2 mt-auto pt-2">
                       ...
                       <button 
                          ...
                          className={`flex-1 py-2 rounded-lg text-xs font-black uppercase tracking-widest transition-all active:scale-95 ${isSelected ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200' : 'bg-stone-900 text-white hover:bg-black'}`}
                       >
                          {isSelected ? '当前使用中' : '使用此地图'}
                       </button>
                    </div>
                  </div>
                );
