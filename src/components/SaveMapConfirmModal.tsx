            ...
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mt-2">
               <div className="flex items-start gap-3">
                 ...
                 <div className="flex-1">
                   ...
                   >
                     <div className={`w-4 h-4 rounded border flex items-center justify-center transition-colors ${isOfficial ? 'bg-amber-500 border-amber-500 text-white' : 'border-stone-300 bg-white group-hover:border-amber-400'}`}>
                       {isOfficial && <span className="text-[10px] font-bold">✓</span>}
                     </div>
                     <span className="text-xs font-bold text-stone-700 select-none">保存到官方云图册</span>
                   </label>
                 </div>
               </div>
            </div>
